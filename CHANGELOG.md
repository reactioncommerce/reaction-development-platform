# v4.1.0
This release is coordinated with the release of [reaction-admin v4.0.0-beta.14](https://github.com/reactioncommerce/reaction-admin/releases/tag/v4.0.0-beta.14), [reaction v4.1.5](https://github.com/reactioncommerce/reaction/releases/tag/v4.1.5), [example-storefront v5.1.1](https://github.com/reactioncommerce/example-storefront/releases/tag/v5.1.1) to keep the `reaction-development-platform` up-to-date with the latest version of all our development platform projects.
# v4.0.1
