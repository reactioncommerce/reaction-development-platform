...
This release is coordinated with the release of [Reaction v3.8.0](https://github.com/reactioncommerce/reaction/releases/tag/v3.8.0) to keep the `reaction-development-platform` up-to-date with the latest version of all our development platform projects.
