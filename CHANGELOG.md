# v3.12.1
This release is coordinated with the release of  to keep the `reaction-development-platform` up-to-date with the latest version of all our development platform projects.
# v3.12.0
