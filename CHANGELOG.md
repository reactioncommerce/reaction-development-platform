# v4.0.1
This release is coordinated with the release of [reaction-admin v4.0.0-beta.4](https://github.com/reactioncommerce/reaction-admin/releases/tag/v4.0.0-beta.4), [reaction v4.0.0](https://github.com/reactioncommerce/reaction/releases/tag/v4.0.0), [example-storefront v5.0.2](https://github.com/reactioncommerce/example-storefront/releases/tag/v5.0.2) to keep the `reaction-development-platform` up-to-date with the latest version of all our development platform projects.
# v4.0.0
